...
type ABCIClient interface {
	...
	ABCIQuery(path string, data tmbytes.HexBytes) (*ctypes.ResultABCIQuery, error)
	ABCIQueryWithOptions(path string, data tmbytes.HexBytes,
...
func (c *HTTP) ABCIQuery(path string, data tmbytes.HexBytes) (*ctypes.ResultABCIQuery, error) {
	return c.ABCIQueryWithOptions(path, data, client.DefaultABCIQueryOptions)
}

func (c *HTTP) ABCIQueryWithOptions(path string, data tmbytes.HexBytes, opts client.ABCIQueryOptions) (*ctypes.ResultABCIQuery, error) {
...
func (c *HTTP) QueryStore(key tmbytes.HexBytes, storeName string) ([]byte, error) {
