...
func (w *WSEvents) ABCIQueryWithOptions(path string, data tmbytes.HexBytes, opts client.ABCIQueryOptions) (*ctypes.ResultABCIQuery, error) {
...
func (c *WSClient) ABCIQueryWithOptions(ctx context.Context, id rpctypes.JSONRPCStringID, path string, data tmbytes.HexBytes, opts client.ABCIQueryOptions) error {
