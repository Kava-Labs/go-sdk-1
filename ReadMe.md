...
```go
require (
	github.com/kava-labs/binance-chain-go-sdk latest
)
...
For more API usage documentation, please check the [wiki](https://github.com/kava-labs/binance-chain-go-sdk/wiki)..
